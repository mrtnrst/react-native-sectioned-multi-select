...
class SectionedMultiSelect extends PureComponent {
  static propTypes = {
    ...
    numSectionsToRender: PropTypes.number,
    numItemsForSectionToRender: PropTypes.number,
  }
  ...
  static defaultProps = {
    ...
    numSectionsToRender: 15,
    numItemsForSectionToRender: 10,
  }
                      ...
                      {items && renderItems && renderItems.length ?
                        <View>
                          <FlatList
                            ...
                            initialNumToRender={numSectionsToRender}
                            data={renderItems}
